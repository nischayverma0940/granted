...
function createSlot3(ownerName) {
  ...
  const Slot22 = React20.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime13.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React20.isValidElement(newElement) ? React20.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable3(child) {
  return React20.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER3;
}
...
function useEffectEvent(callback) {
  ...
  return React21.useMemo(() => (...args) => ref.current?.(...args), []);
}
...
var SelectTrigger = React36.forwardRef(
  (props, forwardedRef) => {
    ...
    const pointerTypeRef = React36.useRef("touch");
...
var SelectValue = React36.forwardRef(
  (props, forwardedRef) => {
...
var SelectIcon = React36.forwardRef(
  (props, forwardedRef) => {
...
var SelectContent = React36.forwardRef(
  (props, forwardedRef) => {
...
var SelectContentImpl = React36.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
    ...
    const [selectedItemText, setSelectedItemText] = React36.useState(
      null
    );
    const getItems = useCollection(__scopeSelect);
    ...
    useFocusGuards();
    const focusFirst2 = React36.useCallback(
      (candidates) => {
    ...
    const focusSelectedItem = React36.useCallback(
    ...
    const itemRefCallback = React36.useCallback(
      (node, value, disabled) => {
    ...
    const itemTextRefCallback = React36.useCallback(
      (node, value, disabled) => {
        const isFirstValidItem = !firstValidItemFoundRef.current && !disabled;
        const isSelectedItem = context.value !== void 0 && context.value === value;
        if (isSelectedItem || isFirstValidItem) {
...
var SelectItemAlignedPosition = React36.forwardRef((props, forwardedRef) => {
  ...
  const handleScrollButtonChange = React36.useCallback(
    (node) => {
...
var SelectViewport = React36.forwardRef(
  (props, forwardedRef) => {
...
var SelectGroup = React36.forwardRef(
  (props, forwardedRef) => {
...
var SelectLabel = React36.forwardRef(
  (props, forwardedRef) => {
...
var SelectItem = React36.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
      value,
...
var SelectItemText = React36.forwardRef(
  (props, forwardedRef) => {
    ...
    const nativeOption = React36.useMemo(
...
var SelectItemIndicator = React36.forwardRef(
  (props, forwardedRef) => {
...
var SelectSeparator = React36.forwardRef(
  (props, forwardedRef) => {
...
var SelectArrow = React36.forwardRef(
  (props, forwardedRef) => {
...
var SelectBubbleInput = React36.forwardRef(
...
function useTypeaheadSearch(onSearchChange) {
  ...
  const handleTypeaheadSearch = React36.useCallback(
    (key) => {
...
//# sourceMappingURL=chunk-O4LWYOMW.js.map
